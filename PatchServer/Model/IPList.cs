...
namespace Monitor.PatchServer.Model
{
    public class IPList
    {
        ...
        private async Task PingAndUpdateAsync(Ping ping, string ip)
        {
            ...
            if(reply.Status == IPStatus.Success)
            {
                ...
                ipList.Add(new IPItem { IPAddress = ip, Status = "Connected", During="0", IsChecked=false, IconImage = "pack://application:,,,/Resource/connect.png" });
